...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =  // MIDI
{
 ...
 */
const USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor = // MIDI
{
	.Config =
		{
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(USB_DESCRIPTOR_STRING);

/** Product descriptor string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(PRODUCT_STRING);
...
MIDIBootMode=false; // debug
	...
	{
		case DTYPE_Device:
			if (MIDIBootMode) 			Address = &DeviceDescriptor;
